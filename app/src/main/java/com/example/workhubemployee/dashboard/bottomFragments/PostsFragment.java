...
public class PostsFragment extends Fragment {
    ...
    private void displyAllPosts() {
        ...
        adapter = new FirestoreRecyclerAdapter<PostModel, PostsFragment.PostViewHolder>(options) {
            @NonNull
            @Override
            public PostsFragment.PostViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(getActivity()).inflate(  R.layout.item_post,parent,false);
                return new PostsFragment.PostViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull  PostsFragment.PostViewHolder holder, int position, @NonNull  PostModel model) {
